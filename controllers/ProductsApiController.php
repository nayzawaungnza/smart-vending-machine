...
class ProductsApiController {
    ...
    $limit = $_GET['limit'] ?? 10; // Default to 10 items per page
    $offset = $_GET['offset'] ?? 0; // Default to start from the first item
    $sortField = $_GET['sortField'] ?? 'name'; // Default sorting field
    $sortOrder = $_GET['sortOrder'] ?? 'asc'; // Default sorting order
